  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
    ...
    function RN(module, __webpack_exports__, __webpack_require__) {
      ...
      DashboardPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__["DashboardPageRoutingModule"]],
    ...
    function ckw(module, __webpack_exports__, __webpack_require__) {
      ...
      var DashboardPage = /*#__PURE__*/function () {
        function DashboardPage(formBuilder, router, http, auth) {
        ...
        _createClass(DashboardPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.http.post(this.baseUrl + '/admin/dashboard', {}).subscribe(function (data) {
              if (data['response'] && data['response']) {
                _this.todayOrder = data['response'].today;
                _this.totalOrder = data['response'].total;
                _this.todayValue = _this.todayOrder[0] ? _this.todayOrder[0]['totalAmount'] : 0;
                _this.todaycount = _this.todayOrder[0] ? _this.todayOrder[0]['count'] : 0;
                _this.todayAdvance = _this.todayOrder[0] ? _this.todayOrder[0]['advance'] : 0;
                _this.todayBalance = _this.todayOrder[0] ? _this.todayOrder[0]['balance'] : 0;
                _this.todaySettled = _this.todayOrder[0] ? _this.todayOrder[0]['count'] : 0;
                _this.totalValue = _this.totalOrder[0] ? _this.totalOrder[0]['totalAmount'] : 0;
                _this.totalcount = _this.totalOrder[0] ? _this.totalOrder[0]['count'] : 0;
              }
            });
          }
        }, {
