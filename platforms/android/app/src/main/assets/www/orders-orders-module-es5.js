(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["orders-orders-module"], {
    ...
    function EpG(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @ionic/angular */
      "TEn/"); // import { FileTransfer, FileUploadOptions, FileTransferObject } from '@ionic-native/file-transfer/ngx';
      // import { File } from '@ionic-native/file';


      var OrdersPage = /*#__PURE__*/function () {
        function OrdersPage(formBuilder, router, http, auth, toastController
        ...
        _createClass(OrdersPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.http.post(this.baseUrl + '/order/getorders', {}).subscribe(function (data) {
              if (data['response'] && data['response']) {
                _this.orderList = data['response'].data;
              }
            });
          }
        }, {
          ...
          value: function resetForm() {
            ...
            this.orderForm.reset(); // this.orderList = []

            this.http.post(this.baseUrl + '/order/getorders', this.orderForm.value).subscribe(function (data) {
              if (data['response'] && data['response']) {
                _this2.orderList = data['response'].data;
              }
            });
          }
        }, {
          ...
          value: function search() {
            ...
            this.http.post(this.baseUrl + '/order/getorders', this.orderForm.value).subscribe(function (data) {
              if (data['response'] && data['response']) {
                _this3.orderList = data['response'].data;
              }
            });
          }
        }, {
          ...
          value: function _export() {
            ...
            this.http.post(this.baseUrl + '/order/orderExport', this.orderForm.value).subscribe(function (data) {
              if (data['response'] && data['status'] == 1) {
                _this4.presentToast('Report Send Your E-Mail');
                ...
                _this4.presentToast(data['response']);
              }
            });
          }
        }, {
          key: "getdetails",
          value: function getdetails(value) {
            var navigationExtras = {
              queryParams: {
                id: value
              }
            };
            this.router.navigate(['ordersdetails'], navigationExtras); // this.router.navigate(['/ordersdetails']);
