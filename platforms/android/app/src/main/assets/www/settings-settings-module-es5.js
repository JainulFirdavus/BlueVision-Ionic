  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["settings-settings-module"], {
    ...
    function nD9t(module, __webpack_exports__, __webpack_require__) {
      ...
      var SettingsPage = /*#__PURE__*/function () {
        function SettingsPage(formBuilder, auth, router, toastController) {
        ...
        _createClass(SettingsPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.auth.getsettings().subscribe(function (response) {
              if (response['status'] != 0) {
                _this.settingForm.patchValue(response['response']);
              }
            });
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            if (this.settingForm.invalid) {
              ...
              this.auth.savesettings(this.settingForm.value).subscribe(function (response) {
                if (response['status'] == 0) {// localStorage.setItem('order', JSON.stringify(this.orderForm.value)); // testing
